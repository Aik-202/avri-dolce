  ...
  return (
    <section className='flex flex-row w-screen pl-5'>
      <div className='flex flex-col space-y-5'>
        ...
        The search is over!! <i className='text-dark-green font-bold'>Avri Dolce</i> is thw way to go with, offering you all kinds of clothings 
      ...
      <figure>
        {/* <img src={av} alt="product one" className='w-[20rem]' /> */}
      </figure>
    </section>
  )
}

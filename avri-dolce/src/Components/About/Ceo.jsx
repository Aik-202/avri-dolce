...
export default function Ceo() {
  ...
  return (
    <section className='flex flex-col justify-center items-center space-y-10 w-screen'>
      ...
      <div className='flex flex-row justify-center space-x-10 pl-5 w-[inherit]'>
        <p className='self-center w-[90%] md:w-[40%] font-p-font text-base font-semibold'>
        ...
        <figure className='flex flex-row space-x-5 w-max'>
          ...
          <div className='h-[30rem] w-[30rem] rounded-md]'>

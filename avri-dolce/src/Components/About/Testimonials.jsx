...
export default function Testimonials() {
  return (
    <section className='flex flex-col justify-center items-center space-y-10'>
        <h2 className='font-h-font text-3xl font-bold text-red tracking-wide'>WHAT OUR CUSTOMERS SAY</h2>
        ...
        <section className='grid grid-cols-4 gap-8'>
            {ratings.map((item) => <div className='bg-gray px-5 py-5 rounded-md shadow-md'>

...
export default function KnowUs() {
  return (
    <section className='flex flex-col justify-center items-center space-y-10'>
      ...
      <img src={locate} alt="locate" className='self-center w-[90%] md:w-[90%] lg:w-auto' />
      <div className='grid grid-cols-1 gap-y-10 md:gap-y-0 md:grid-cols-2 lg:grid-cols-3 md:gap-x-10'>
        {know.map((list) => <div className='flex items-center flex-col w-[17rem] xl:w-[20rem]' key={list.head}>

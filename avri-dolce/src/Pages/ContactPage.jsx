  ...
  return (
    <section className='flex flex-col space-y-10'>
      ...
      <section className='relative flex justify-center w-screen h-screen'>
        ...
        <div className='flex flex-col z-20 bg-gray p-5 rounded-md shadow-md h-max mt-20'>
          ...
          items-center mt-5 rounded-md bg-white p-2'>
            <img src={item.img} className='w-[30px]' />
            <a href={item.link} className='select-text font-b-font hover:text-dark-green'>{item.name}</a>
          </div>)}
        </div>
      </section>
    </section>
